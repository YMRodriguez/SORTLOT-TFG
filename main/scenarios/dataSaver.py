...
def persistStats(stats, ID):
    pathlib.Path(os.path.dirname(
        __file__) + os.path.sep + 'results' + os.path.sep + 'articleP1' + os.path.sep + 'simulation').mkdir(
        parents=True, exist_ok=True)
    with open(os.path.dirname(
            __file__) + os.path.sep + 'results' + os.path.sep + 'articleP1' + os.path.sep + 'simulation' + os.path.sep + str(
